...
def calculate_avalanche_days(df):
    ...
    # conditions = [
    #     df['L1'].isin([1, 2, 3, 4]),  # L1 is 2, 3, or 4
    #     df['L1'] == 0
    # ]
...
def main():
    ...
    filepath = common_path / 'Season_24_25.csv'

    # output_filepath = common_path / 'mod1_newfeatures_NEW.csv'
    output_filepath = common_path / 'Season_24_25_NEW.csv'
    # summary_filepath = common_path / 'mod1_newfeatures_NEW_summary.csv'
    summary_filepath = common_path / 'Season_24_25_summary.csv'

    # --- DATA IMPORT ---

    # Load and clean data
    mod1 = load_data2(filepath)
